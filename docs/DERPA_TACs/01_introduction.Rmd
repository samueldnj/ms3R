...
interacting species. Management decisions, such as total
allowable catches (TACs) are often made for
...
natural mortality rates and recruitment process errors, and
are unable to capture anything about technical interactions.

Ignorance of technical interactions while setting TACs will 
often lead to sub-optimal fishery outcomes. For example, 
under-utilisation of TAC could occur when multiple quota species
are caught in the same fishing effort, creating a choke point
on the management system (REF). In turn, under-utilised TACs
will create uninformative catch data, which may degrade stock
assessment performance over successive fishing seasons.
