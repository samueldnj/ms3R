...
interacting quota species are caught 
at different rates (i.e., catchability) by a common gear, 
or have different productivity levels, leading to a choke
constraint in which one species quota is filled before  
the others [@baudron2015adverse]. Choke constraints are 
