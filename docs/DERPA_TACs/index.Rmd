...
author: 
  - Samuel D. N. Johnson^1^ (corresponding)
  - Sean P. Cox^1^
affil:
...
abstract: 
    ...
    We tested the management performance when using each of 
    five surplus production stock assessment models to set harvest 
    levels in a multi-species fishery, including single-stock 
    and hierarchical multi-stock assessments, and methods that 
    pooled data across species and spatial strata. Each assessment 
    method was tested under four data scenarios, which successively 
    excluded biomass indices to reduce data quantity. 
...
csl: ./Users/sdnjohnson/Work/write/templates/csl/styles/dependent/fisheries-research.csl 
