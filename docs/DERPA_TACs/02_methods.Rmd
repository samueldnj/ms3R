...
We measured our MP performance against the performance of 
simulations using an omniscient manager.

Because several of the 9 DER complex stocks
are in healthy states at the beginning of the projection
period ($B > B_{MSY}$) we 
