...
OM observation error SD across all stocks was around $0.3$ (CHECK), 
which is already somewhat uninformative, and in preliminary
simulations we found that the convergence rate of
single-stock and hierarchical multi-stock assessment 
model configurations became unacceptably low.
