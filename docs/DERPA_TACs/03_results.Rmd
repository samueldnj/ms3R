...
same time period (Figure 8), to understand the biomass and catch 
trade-offs between different model choices, and to compare each model 
to the omniscient manager's optimal solution.
...
uncertain under less informative priors. The Total Aggregation and Spatial 
