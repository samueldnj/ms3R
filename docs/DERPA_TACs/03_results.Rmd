...
When replicates included time steps where assessment models 
would not converge (largely due to data quality issues)
...
From methods: does this still apply???
We used the skewed yield curve
