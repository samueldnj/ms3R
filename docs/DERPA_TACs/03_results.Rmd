...
state where $B_{s,p,t} < 0.4 B_{MSY,SS,s,p}$ under the High and Mod data 
scenarios, while under the Low scenario a small probability of being 
critically overfished was observed under the Species Pooling (max 1\%) and 
Spatial Pooling (max 6\%) AMs. As expected, there were higher probabilities 
of being overfished ($B_{s,p,t} < 0.8 B_{MSY,SS,s,p}$) under all scenarios,
with the highest observed at 22\% under the Spatial Pooling AM and Low 
scenario. The Single-species AM never overfished any stock under any data 
scenario, as it always underestimated at least one species' biomass in each
