...
DER complex data. To improve AM convergence in the simulations, we 
multipled all estimates by $0.75$ to improve observation model 
precision (multiplier found by trial and error).
...
tauObs_spf <- round(tauObs_spf * 0.75,3)
