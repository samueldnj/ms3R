...
```{r loadStuffAgain, echo = FALSE, include = FALSE, warning = FALSE}
.loadSim("sim_parBatDERTACS_reruns_tunedHMS_Sep2417", folder= params$groupFolder)
...
```{r fig8-tulipBtCtHMSPoor, echo = FALSE, warning = FALSE, fig.cap = tulipBtCtHMSPoorCap, fig.width = 9, out.width = "9in" }
plotTulipBt(  obj = blob, nTrace = 3,
              dep = TRUE,
              ref = "B0",
              Ct  = TRUE,
