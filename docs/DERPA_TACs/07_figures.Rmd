...
.loadSim("sim_parBatMPgrid_DLSurveys7_.5Tau_Long2", folder= params$groupFolder)
...
plotBatchLossDists_Scenario(  groupFolder = "DLSurveys7_.5tau_Long",
                              prefix = "MPgrid_DLSurveys7",
                              lossType = "rel",
                              var = "C_ispt",
                              period = 73:82,
                              lossList = NULL,
