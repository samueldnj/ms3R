...
#                   dataCells = c( "Indices",
#                                  "Catch") )
figPath <- file.path("./data/fig2-DERcplxData.pdf")
knitr::include_graphics(figPath)
...
# plotAMschematic()
figPath <- file.path("./data/fig3-AMschematic.pdf")
knitr::include_graphics(figPath)
...
figPath <- file.path("./data/fig4-omniRunTulipBt.pdf")
knitr::include_graphics(figPath)
...
figPath <- file.path("./data/fig5-omniEffortTulip.pdf")
knitr::include_graphics(figPath)
...
figPath <- file.path("./data/fig6-lossRankDists.pdf")
knitr::include_graphics(figPath)

```

<!-- {r loadSSLow, echo = FALSE, include = FALSE, warning = FALSE}
.loadSim("sim_parBatDERTACs_reruns_Oct10_16", folder= params$groupFolder)
...
figPath <- file.path("./data/fig7-retroBioSingleRepSSLow.pdf")
knitr::include_graphics(figPath)
...
# plotLossTulip(  sim = "sim_parBatDERTACs_reruns_Oct10_16", 
...
figPath <- file.path("./data/fig8-tulipCatLossSSLow.pdf")
knitr::include_graphics(figPath)

```

<!-- {r loadHMSLow, echo = FALSE, include = FALSE, warning = FALSE}
.loadSim("sim_parBatDERTACs_reruns_Oct10_17", folder= params$groupFolder)
...
figPath <- file.path("./data/fig10-tulipCatLossHMSLow.pdf")
knitr::include_graphics(figPath)
...
figPath <- file.path("./data/fig11-catchBioTradeoff.pdf")
knitr::include_graphics(figPath)
```
...
figPath <- file.path("./data/fig12-regLossSensitivityRuns.pdf")
knitr::include_graphics(figPath)
