...
figPath <- file.path("./data/fig1-DERcomplexStockAreas.pdf")
...
```{r fig9-retroBioSingleRepSSPoor, echo = FALSE, warning = FALSE, fig.cap = retroBioSingleRepSSPoorCap, fig.width = 9, out.width = "9in" }
...
```{r fig8-tulipBtCtSSPoor, echo = FALSE, warning = FALSE, fig.cap = tulipCatLossSSSPoorCap, fig.width = 9, out.width = "9in" }
...
```{r fig11-regLossSensitivityRuns, echo = FALSE, warning = FALSE, fig.cap = batchLossSensSummaryCap, fig.width = 9, out.width = "9in", fig.asp = 0.7  }
plotSensRuns_pub()
