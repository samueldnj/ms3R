...
English and Rock sole demand was very elastic, while Dover sole
...
effect, given the uninformative data. 
...
invDemTable[1,4:5] <- round(coef(invDemCurves[[1]]),3)
...
BC GDP per capita grew at the fixed rate of 3.9\% per year 
