...
by evalutating them in the presence of realistic uncertainty about stock
status via closed loop simulation. We simualted a three species complex 
of right-eyed flounders (*Pleuronectidae Spp.*) - Dover sole (*Microstomus 
pacificus*), English sole (*Parophrys vetulus*), and (Southern) Rock sole 
(*Lepidopsetta bilineata*) - fished in three spatial strata by a common 
trawl fishery off the coast of British Columbia (BC), Canada. Species 
demand curves with a constant price elasticity of demand were estimated 
via a 2-stage least-squares regression [@angrist2008mostly], and combined 
with area-specific costs of fishing to define a production function that 
depended on the spatial allocation of fishing effort. Single species MSY, 
...
a 60-year projection with recruitment process error, where the either 
...
single-species MSY strategies. ADD FINAL SENTENCE ON IMPLICATIONS
