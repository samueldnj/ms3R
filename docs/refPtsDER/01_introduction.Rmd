...
net-present-value (NPV) of the fishery was maximised. Finally, we compared 
the management outcomes of harvest strategies targeting single- and 
multi-species MSY and MEY reference points by evaluating the economic 
and conservation risks of each in the presence of realistic uncertainty 
about stock status via closed loop simulation.
