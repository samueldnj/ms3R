...
relationships with technical interactions as outlined above, and evaluation 
of net benefits are straigtforward if cost functions are simple (e.g., 
linear in fishing effort). More sophistication is 
