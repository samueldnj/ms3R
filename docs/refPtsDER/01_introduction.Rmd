...
In this paper, we asked whether there was increased risk of lost
resource rent or lost catch yield if fishery managers ignored correlation 
in market prices and recruitment deviations when setting catch limits
in multi-species fisheries. We used closed loop simulation to simulate
a three species complex of right-eyed flounders (*Pleuronectidae Spp.*) - 
...
spatially heterogeneous areas by a common trawl 
fishery off the coast of British Columbia (BC), Canada. Steady-state 
...
heterogeneous costs of fishing and downward sloping demand curves when 
deriving resource rent from those steady state solutions. 
...
yield or the net present value of the DER complex fishery, and simulated 
dynamics included correlation in recruitment process deviations and/or 
market price fluctuations. Risk was measured by comparing distributions 
of biomass, catch, and net present value when optimal harvest 
rates were used to set TACs in closed loop simulation, under correlation 
scenarios and both perfect and imperfect knowledge about stock biomass.
