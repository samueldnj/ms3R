...
[@angrist2008mostly], and then combined with area-specific costs of 
fishing to define a production function that depended on the spatial 
allocation of fishing effort. Single species MSY, multi-species MSY, and 
MEY reference points were estimated via yield-per-recruit analysis 
