...
in all three areas, with the largest shifts in HSHG and WCVI, where Dover
sole stocks were the largest, and the smallest change was in the 
QCS area, where Dover sole still dominates but the stock size is
smaller in absolute terms. Dependence on Dover sole is based
on the assumed US west coast catches of around 9kt (Figure 2 top
