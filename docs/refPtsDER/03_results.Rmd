...
values for the optimisation. Sean says it should be scaled to productivity?
...
producer surplus maximising harvest rates under was lower, distributions
...
to avoid unrealistically high net-present values of producer surplus under 
some simulation replicates. 
[**concrete differences in percentiles**]
 
Median producer surplus under both objective functions was higher than 
the steady-state solution (compare producer surplus columns, Tables 4 and 
...
the stochastic optimisation, median producer surplus was over three times 
the steady state estimate in HSHG, around two times in QCS, and 9\% lower
in WCVI. The objective function maximising producer surplus also produced
higher producer surplus in general, achieving 88\% higher surplus in HSHG, 
50\% higher in QCS, and 14\% higher in WCVI. Higher producer surplus in
general is caused by the [**ability of prices to climb higher through price
...
there were some notable differences in median producer surplus in
