...
```{r fig12-sensRentTulips, echo = FALSE, warning = FALSE, fig.cap = sensRentTulipsCap }
figPath <- file.path("./figure/fig12-sensRentTulips.pdf")
if(params$redoPlots | !file.exists(figPath))
{
  graphics.off()
  pdf(file = figPath, width = 8.5, height = 11)
  compareTulipRent( groupFolder = "omniRuns_Sens_May14",
                    scenarios = "noCorr",
                    mps = c("omni_totProfit1_freeEff"),
                    rpSim = "sim_baseRun_invDem",
                    fleets = 2,
                    proj = TRUE,
                    plotPoly = FALSE )
