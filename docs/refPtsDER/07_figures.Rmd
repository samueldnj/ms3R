...
if(params$redoPlots | !file.exists(figPath))
{
  graphics.off()
  pdf(file = figPath, width = 8.5, height = 11)
  compareTulipEffort( groupFolder = "omniRuns_noCorr_Mar26",
                      scenarios = "noCorr",
                      rpSim = params$sim,
                      fleets = 1:2,
                      combineEff = TRUE,
...
if(params$redoPlots | !file.exists(figPath))
{
  graphics.off()
  pdf(file = figPath, width = 8.5, height = 11)
  plotDynUmsy_sp( groupFolder = "omniRuns_noCorr_Mar26",
                  mpFilter = "freeEff",
...
```{r fig10-bioDist, echo = FALSE, warning = FALSE, fig.cap = bioDistCap }
figPath <- file.path("./figure/fig10-bioDist.pdf")
if(params$redoPlots | !file.exists(figPath))
{
  graphics.off()
  pdf(file = figPath, width = 8.5, height = 11)
