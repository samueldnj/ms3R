...
inflation. All ex-vessel prices were specific to the bottom trawl fishery 
except for English Sole in 2016, which was an outlier with a trawl ex-vessel 
price almost three times the 2006 - 2016 average, and so was replaced with
the 2016 ex-vessel price for English sole averaged across all available gear
types. Fuel costs of fishing data were taken from a 2009 economic analysis 
of the BC trawl fishery [@nelson2011pacific-commerc].
...
inverse demand curve for total species $s$ catch, with a constant elasticity 
of demand, i.e.,
\begin{equation} 
...
$v^{*}_{s,t}$ is the reference price of species $s$ when catch is at 
MSY, $i=0.02$ is an annual inflation rate, $\delta_{s,t} \sim N(0,1)$ is 
the annual random walk jump in ex-vessel prices (logit-scale), and $\tau_s$ 
is the log standard deviation in the ex-vessel price random walk. The time-varyin baseline price was then used
