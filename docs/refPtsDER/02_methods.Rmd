...
value across the distribution of effort time series under each objective 
function and projection scenario. Dynamic optima were compared to the 
steady-state solutions found via the yield curve analysis outlined above. 
Median values were taken over the time period 2040 - 2060, which allowed 
...
percentile as a risk metric is known as *Value-at-risk-p* (VAR-p), which
is a non-parametric definition of riks commonly used in economic 
analyses [REF].
