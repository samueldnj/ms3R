...
Economic results depended on the size of resource rents extracted from 
each area, which were dependent on ex-vessel prices (demand) for each 
species and the discount rate applied to calculate the NPV. We tested the 
sensitivity of economic results to three main uncertainties (Table X). First,
we tested the common assumption of a constant price, or a flat demand 
relationship, by setting price elasticity of demand to be infinite (i.e., 
zero price flexibility) for YPR calculations, and by setting the growth 
in household income to be zero for stochastic optimisation. Differences in 
projected demand were modeled using different 
levels of growth in household income, shifting by 1 standard deviation up 
and down from the recent mean value of 3.9\% ^[https://www2.gov.bc.ca/assets/gov/british-columbians-our-governments/government-finances/financial-economic-review/financial-economic-review-2020.pdf].
