...
models within a fixed $M_t$ projection scenario. Operating models with
...
limit reference point, and was also higher on the stock-recruit curve. As
expected, the most extreme cases where operating models perceived a 
large (high $B_0$) and unproductive (low stock-recruit steepness) stock 
were unable to rebuild in the 15 year projection under any projection
scenario and rebuilding procedure.


One reason that operating model dynamics dominated the rebuilding
...
biomass, around $50.76$ kt when aggregated over the entire HG area, which
was higher than the aggregate unfished biomass for 11 of the 18 historical
operating models. While the lower control point of
...
values), harvest rates would have been very low under the more
