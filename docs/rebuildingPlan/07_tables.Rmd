...
eqWtd_perfTableFull <- perfTable %>%
                        ...
                        mutate( pBtGt.3B0   = round(pBtGt.3B0,2),
                                ...
                                pBtGtB0     = round(pBtGtB0,2),
                                pBtGtHistSB = round(pBtGtHistSB,2),
                                pBtGt.5HistSB = round(pBtGt.5HistSB,2),
...
write.csv(eqWtd_perfTableFull, file = "./data/eqWtd_Full.csv")

eqWtd_perfTable_Biomass <- eqWtd_perfTableFull %>%
                            select( RP = mp,
                                    "$P(B_t \\geq 0.3 B_0)$"  = pBtGt.3B0, 
                                    "$P(B_t \\geq 0.5 B_0)$"  = pBtGt.5B0, 
                                    "$P(B_t \\geq B_0)$"      = pBtGtB0, 
                                    "$P(B_t \\geq 0.5 B_{1975:1985})$"  = pBtGt.5HistSB, 
                                    "$P(B_t \\geq B_{1975:1985})$"      = pBtGtHistSB, 
...
write.csv(bestOM_perfTable, file = "./data/bestOM_fullTable.csv")
...
worstOM_perfTable <- perfTable %>%
                    ...
                    mutate( pBtGt.3B0 = round(pBtGt.3B0,3),
                            pBtGt.5B0 = round(pBtGt.5B0,3),
                            pBtGtB0 = round(pBtGtB0,3),
                            pBtGt.5HistSB = round(pBtGt.5HistSB,3),
                            pBtGt.5B0 = round(pBtGt.5B0,3),
                            growthRate6yrs = round(100*growthRate6yrs,1),
                            growthRate11yrs = round(100*growthRate11yrs,1),
                            growthRate16yrs = round(100*growthRate16yrs,1),
...
write.csv(worstOM_perfTable, file = "./data/worstOM_fullTable.csv")
