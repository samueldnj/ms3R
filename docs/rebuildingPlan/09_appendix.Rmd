...
write.csv(eqWtd_perfTable_subAreas, file = "./data/eqWtd_Areas_fullTable.csv")
...
write.csv(bestOM_perfTable_subAreas, file = "./data/bestOM_Areas_fullTable.csv")
...
write.csv(worstOM_perfTable_subAreas, file = "./data/worstOM_Areas_fullTable.csv")
